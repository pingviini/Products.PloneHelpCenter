...
KnowledgeBaseSchema = folder.ATBTreeFolderSchema.copy() + \
                        HelpCenterContainerSchema
schemata.finalizeATCTSchema(KnowledgeBaseSchema, moveDiscussion=False,
                            folderish=True)


class HelpCenterKnowledgeBase(PHCFolder, folder.ATBTreeFolder):
    """A Single-Folder KnowledgeBase that can organize a large number of
    how-tos and tutorials by topic and audience.
    """
    ...
    typeDescription = 'A Single-Folder KnowledgeBase that can organize a '\
                      'large number of how-tos and tutorials by topic and '\
                      'audience.'
