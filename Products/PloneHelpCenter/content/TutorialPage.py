...
TutorialPageSchema = document.ATDocumentSchema.copy()
HideOwnershipFields(TutorialPageSchema)


class HelpCenterTutorialPage(document.ATDocumentBase):
    """Part of a tutorial."""
    ...
    typeDescription = 'A Tutorial Page contains the text of a single page of '\
                      'the tutorial.'
